  ...
  hero: {
    ...
    phone: {
      ...
      thread: [
        ...
        { in: 'The rest is just FYI. You\u2019re clear until Friday.' },
      ],
  ...
  how: {
    ...
    phone: {
      ...
      thread: [
        ...
        {
          kind: 'in',
          text: "On it. His physical is covered in-network, and there's an opening Thursday at 4:10. I filled in both forms.",
        },
        {
          kind: 'in',
  ...
  circles: {
    ...
    chat: {
      ...
      messages: [
        ...
        { from: 'Axolotl', text: 'That\u2019s set: Dana has Wednesday, Sam has Friday. I\u2019ll remind you both Thursday night.' },
      ],
    },
