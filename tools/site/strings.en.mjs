...
export default {
  ...
  hero: {
    ...
    phone: {
      ...
      metaTime: '7:15 AM',
      thread: [
        { in: 'Eight school emails came in this week. One thing needs you:' },
        { in: 'The field trip form for Maya, due Friday. I filled it in and it\u2019s ready to send.' },
        { in: 'Wednesday\u2019s early release at 1:20 is handled \u2014 Grandma\u2019s got Leo, and she confirmed.' },
        { in: 'Leo\u2019s ride to Lincoln is requested from the district, under McKinney-Vento.' },
        { in: 'The rest are FYI. Want me to send the form?' },
        { out: 'yes' },
        { in: 'Sent. Lincoln\u2019s office confirmed it \u2014 reference K-1042.' },
      ],
      alt: 'Text thread on a phone. Axolotl reports eight school emails from the week: the field trip form for Maya is filled in and needs the parent\u2019s yes; Wednesday\u2019s early release is handled with Grandma picking up Leo; Leo\u2019s ride to Lincoln is requested from the district under McKinney-Vento. The parent replies yes, and Axolotl confirms the school accepted the form, reference K-1042.',
    },
    ...
    cols: [
      {
        ...
        turns: [
          { in: 'The district calendar came out. One thing in it needs you.' },
          { in: 'Wednesday is early release at 1:20 — the kids are out three hours early.' },
          { out: 'I have meetings until 3 that day.' },
      ...
      },
      {
        ...
        turns: [
          ...
          { out: 'Yes, please.' },
          { in: 'She\u2019s got them. I told the office they\u2019re covered.' },
        ],
        status: 'waiting',
      },
      {
        ...
        turns: [
          { in: 'Three things this week.' },
          { in: 'Pajama day Thursday, the field trip form due Friday, and Leo needs an absence note.' },
          { out: 'He has a dentist appointment Monday morning.' },
          { in: 'The absence note is drafted and the form is filled in. Reply YES to send both.' },
          { out: 'Yes' },
          { in: 'Both sent. The office confirmed.' },
        ],
        status: 'waiting',
      },
      {
        ...
        turns: [
          ...
          { in: 'Sam sees the same list. I\u2019ll remind whoever\u2019s on it.' },
          { out: 'Thank you.' },
          { in: 'Happy to. I\u2019ll check in Friday.' },
        ],
        status: 'reminder',
      },
    ],
  ...
  how: {
    ...
    phone: {
      ...
      thread: [
        {
          kind: 'in',
          text: "Leo's school sent a note. One thing needs you: kindergarteners need a physical and a dental check on file by October 15. Leo is missing both.",
        },
        {
          kind: 'in',
          text: "His physical is covered in-network, and there's an opening Thursday at 4:10. I filled in both forms.",
        },
        {
          kind: 'in',
          text: 'Ready to send: Leo Howard, Kindergarten, physical and dental. Reply YES and I\u2019ll book it and submit.',
        },
        { kind: 'out', text: 'Yes' },
        {
          kind: 'in',
          text: 'Submitted. Lincoln Elementary confirmed it. Reference K-1042.',
        },
      ],
      caption: 'Example conversation. Fictional school and family.',
      alt: 'Text conversation on a phone: Axolotl says Leo needs a physical and a dental check on file by October 15 and that both forms are filled in. The parent replies Yes, and Axolotl confirms Lincoln Elementary accepted it, reference K-1042.',
    },
    channel: {
  ...
  circles: {
    ...
    chat: {
      alt: "Example group chat in the Messages app. You, Dana and Sam work out Wednesday's early release: Dana takes all four kids, and Sam covers her Friday pickup. Every family said yes.",
      group: 'You, Dana, Sam',
      meta: 'Today',
      metaTime: '8:02 AM',
      messages: [
        { from: 'You', out: true, text: 'Wednesday we can\u2019t get them \u2014 we\u2019re both stuck until 5.' },
        {
          from: 'Axolotl',
          text: "Dana's free Wednesday. She can take all four kids if someone covers her Friday pickup. Does that work?",
        },
        { from: 'Dana', text: 'Works for me.' },
        { from: 'Sam', text: "I've got Friday." },
        { from: 'Axolotl', text: "That's everyone. Dana has Wednesday, Sam has Friday." },
      ],
    },
