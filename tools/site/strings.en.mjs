...
export default {
  ...
  hero: {
    ...
    phone: {
      ...
      metaTime: '7:15 AM',
      cardTitle: 'This week',
      alt: 'Text thread on a phone. Axolotl sends a card titled "This week" listing five things: Wednesday\u2019s early release at 1:20, confirmed with Grandma picking up Leo; Maya\u2019s field trip form, filled in and waiting for the parent\u2019s yes; Leo\u2019s ride to Lincoln, requested from the district under McKinney-Vento; Maya\u2019s reading evaluation, requested September 30; and Friday pickup with another family, coming soon.',
    },
    folder: {
    ...
    cols: [
      {
        ...
        turns: [
          ...
          { card: true },
          { in: 'Grandma can get Leo.' },
          { in: 'Want me to ask her?' },
        ],
        status: 'waiting',
      },
      {
        ...
        turns: [
          { out: 'Fwd: Lincoln Elementary: dismissal at noon today' },
          { in: 'Lincoln just texted.' },
          { in: 'Dismissal at noon — twelve minutes from now.' },
          { out: "I can't leave. I'm in meetings until 3." },
          { card: true },
          { in: 'Grandma is first on your backup list.' },
          { in: 'Want me to ask her?' },
        ],
        status: 'waiting',
      },
      ...
      },
      {
        ...
        turns: [
          { link: true },
          { in: 'Here is who is on what this week.' },
          { card: true },
          { out: 'Can you remind Sam about Thursday?' },
          { in: 'Sam sees the same list.' },
          { in: "I'll remind whoever's on it." },
        ],
        status: 'reminder',
      },
    ],
  ...
  how: {
    ...
    phone: {
      ...
      thread: [
        ...
        {
          kind: 'form',
          label: 'Health requirement form',
          rows: [
            ['Student', 'Leo Howard'],
            ['Grade', 'Kindergarten'],
            ['Exam', 'Physical and dental'],
          ],
          caption: 'Reply YES to book and submit.',
        },
        { kind: 'out', text: 'Yes' },
        {
          kind: 'in',
      ...
      stampTop: 'Confirmed by Lincoln Elementary',
      stampBottom: 'Reference K-1042, October 3',
      note: 'all you type is yes',
  ...
  circles: {
    ...
    chat: {
      ...
      metaTime: '8:02 AM',
      messages: [
        { from: 'You', out: true, text: 'Fwd: Lincoln Weekly Update' },
        {
          from: 'Axolotl',
          text: "Wednesday is early release at 1:20. Dana's free, and you and Sam work until 5. Dana can take all four kids if someone covers her Friday pickup. Does that work?",
        },
        { from: 'Dana', text: 'Works for me.' },
        { from: 'Sam', text: "I've got Friday." },
        { from: 'Axolotl', text: 'That is everyone. Dana has Wednesday, Sam has Friday.' },
      ],
    },
