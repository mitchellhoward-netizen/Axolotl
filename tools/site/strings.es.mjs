  ...
  hero: {
    ...
    phone: {
      ...
      thread: [
        ...
        { in: 'La salida temprana del miércoles a la 1:20 sigue sin cubrir. Te dejo listo un mensaje de un toque para la abuela.' },
        { out: 'Eres lo máximo.' },
    ...
    cols: [
      {
        ...
        steps: [
          ...
          'Encontró a quién pedirle en tu lista de respaldo.',
        ],
        turns: [
          ...
          { in: 'La abuela es la primera en tu lista de respaldo. No puedo escribirle yo.' },
          { in: 'Te lo dejo redactado para que sea un toque, y te recuerdo el martes por la noche.' },
          { out: 'Por favor.' },
          { in: 'Listo: «¿Puedes recoger a los tres el miércoles? Salen a la 1:20.»' },
          { out: 'Enviado. Dijo que sí.' },
          { in: 'Anotado: Leo está cubierto. El plantel de Maya todavía necesita a Dana.' },
          { out: 'Mándame lo mismo para Dana.' },
          { in: 'Hecho. Si no lo has hecho, te pregunto el miércoles en la mañana.' },
        ],
        status: 'waiting',
      },
      {
        ...
        turns: [
          ...
          { in: 'La abuela es la primera en tu lista de respaldo. No puedo escribirle yo.' },
          { in: '¿Te dejo el mensaje redactado para que sea un toque?' },
          { out: 'Sí, rápido.' },
          { in: '«¿Puedes recoger a los tres al mediodía? Lincoln adelantó la salida.»' },
          { out: 'Enviado. Ya va.' },
          { in: '¿Quieres que le escriba a la oficina que ella los recoge?' },
          { out: 'Sí, y pide que manden a Leo a la oficina.' },
          { in: 'Enviado. Te aviso en cuanto la oficina confirme.' },
        ],
        status: 'waiting',
      },
      {
      ...
      },
      {
        ...
        turns: [
          ...
          { out: '¿Me puedes recordar hablar con Sam lo del jueves?' },
          { in: 'No puedo escribirle a Sam, pero te lo recuerdo el jueves en la mañana.' },
          { out: 'Hazlo.' },
          { in: 'Listo. ¿Algo más?' },
          { out: '¿Y el viernes? Puede que salga tarde.' },
          { in: 'El viernes sigue sin cubrir. ¿Te dejo un mensaje de un toque para Dana?' },
          { out: 'Sí.' },
          { in: 'Redactado. Envíalo cuando quieras.' },
        ],
        status: 'reminder',
      },
    ],
