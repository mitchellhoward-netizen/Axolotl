...
export default {
  ...
  hero: {
    ...
    phone: {
      ...
      thread: [
        ...
        { in: 'La salida temprana del miércoles también está cubierta: la abuela recoge a Leo y ya confirmó.' },
        { out: 'Eres lo máximo.' },
    ...
    connects: [
      ...
      { icon: 'gmail', label: 'Tu correo' },
      { icon: 'school', label: 'Correo escolar' },
    ...
    cols: [
      {
        ...
        turns: [
          ...
          { out: '¿Y Maya? Está en el otro plantel.' },
          { in: 'Le pregunté a Dana: puede recoger a Maya de camino.' },
          { out: 'Perfecto. Gracias.' },
          { in: 'Los dos nombres están en la lista de recogida y la oficina ya sabe.' },
          { out: '¿Eso cubre también el jueves?' },
          { in: 'El jueves es un día normal. Estás libre hasta el viernes.' },
        ],
        status: 'waiting',
      },
      {
        ...
        turns: [
          ...
          { out: '¿Le dijiste a Leo?' },
          { in: 'Le escribí a su maestra. Ella lo lleva a la oficina al mediodía.' },
          { out: 'Gracias. Qué rápido.' },
          { in: 'La abuela te escribe cuando estén en casa.' },
          { in: 'Voy a seguir los mensajes de la escuela por si algo más se mueve.' },
        ],
        status: 'waiting',
      },
      {
      ...
      },
      {
        ...
        turns: [
          ...
          { in: 'Sam ve la misma lista, y le recordaré a quien le toque.' },
          { out: '¿Y el viernes? Puede que salga tarde.' },
          { in: 'Dana lleva a los cuatro el viernes; lo confirmó esta mañana.' },
          { out: 'Qué bien. ¿Se me olvida algo?' },
          { in: 'La feria del libro dura toda la semana. No hay nada que hacer salvo que quieras mandar dinero.' },
          { out: 'Déjalo.' },
          { in: 'Listo, lo dejo. Te escribo el viernes por la tarde.' },
          { out: 'Gracias.' },
          { in: 'Con gusto. Que tengas buena semana.' },
        ],
        status: 'reminder',
      },
    ],
  ...
  circles: {
    ...
    chat: {
      alt: 'Ejemplo de chat grupal en Mensajes. La familia dice que los dos están atorados el miércoles por la salida temprana y pide ayuda. Axolotl reporta que Dana está libre el miércoles y puede llevar a los cuatro niños; Dana acepta si alguien cubre su recogida del viernes, Sam toma el viernes, y Axolotl confirma el plan: Dana el miércoles, Sam el viernes.',
      group: 'Tú, Dana, Sam',
      meta: 'Hoy',
      metaTime: '8:02',
      messages: [
        ...
        { from: 'Tú', out: true, text: 'Gracias a los dos. ¿A qué hora le digo a la escuela?' },
        { from: 'Axolotl', text: 'A la 1:20. Pongo los cuatro nombres en la lista de recogida y les recuerdo el jueves por la noche.' },
        { from: 'Dana', text: 'Por mí, bien.' },
        { from: 'Axolotl', text: 'Listo. Si algo cambia, le escribo al grupo.' },
      ],
    },
