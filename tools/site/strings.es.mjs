  ...
  hero: {
    ...
    phone: {
      ...
      thread: [
        ...
        { in: 'El resto es solo información. Estás libre hasta el viernes.' },
      ],
  ...
  how: {
    ...
    phone: {
      ...
      thread: [
        ...
        {
          kind: 'in',
          text: 'Ya voy. Su físico está cubierto en la red, y hay lugar el jueves a las 4:10. Llené los dos formularios.',
        },
        {
          kind: 'in',
  ...
  circles: {
    ...
    chat: {
      ...
      messages: [
        ...
        { from: 'Axolotl', text: 'Queda así: Dana el miércoles, Sam el viernes. Les recuerdo el jueves por la noche.' },
      ],
    },
